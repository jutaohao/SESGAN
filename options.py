...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--nz', type=int, default=20, help='size of the latent z vector')
        ...
        self.parser.add_argument('--model', type=str, default='sesgan', help='chooses which model to use.')
        ...
        self.parser.add_argument('--w_adv', type=float, default=0.5, help='Weight for adversarial loss. default=0.5')
